...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className='card-wrapper relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[75%] [aspect-ratio:16/9]'
      ref={refElement}
      onPointerMove={(event) => {
