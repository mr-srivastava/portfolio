...
export default function Overview(props: IOverviewProps) {
  return (
    <div
      id='about'
      className='p-10 lg:p-20 lg:py-40 min-h-screen flex flex-col lg:flex-row items-center justify-around gap-x-30'
    >
      <div>
        <h3
          className='font-extrabold font-oswald tracking-[-10px] text-[250px] lg:text-[350px] relative text-accent leading-[1] text-white'
      ...
      <div>
        <div
          className='font-display whitespace-nowrap text-center drop-shadow-sm text-blue-500 w-fit tracking-[-2px] text-6xl font-bold mb-4 mt-20 lg:mt-0 lg:mb-10'
          style={{ filter: 'blur(0px)', opacity: 1, transform: 'none' }}
        >
          <div
