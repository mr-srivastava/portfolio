            ...
            <AnimatePresence mode="wait">
              {hovered === blog.slug && (
                <motion.div
                  ...
                  className="absolute z-0 pointer-events-none bg-secondary-50 inset-0 h-full w-full   rounded-md "
                />
              )}
            </AnimatePresence>
                ...
                <div className="flex space-x-2 flex-wrap mt-4">
                  {blog.tags?.map((tag, index) => (
                    <span
                      ...
                      className="text-xs px-1 py-0.5 text-secondary-50 font-body border border-neutral-200 bg-primary-950 rounded-md"
                    >
                      {tag}
                    </span>
                  ))}
